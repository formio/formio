...
module.exports = {
  ...
  submission: {
    textField2: 'test value again',
    number2: 200,
    textArea2: 'This is the contents again',
    checkbox2: true,
    selectBoxes2: {
      one: false,
      two: true,
