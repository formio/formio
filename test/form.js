    ...
    describe('Form Merging', function() {
      ...
      describe('Single level nested components', function() {
        ...
        describe('Form with Columns', function() {
          ...
          describe('Updating a column component, which has been moved in front of the component', function() {
            var componentsB = [
              {
                type: 'textfield',
                validate: {
          ...
          describe('Updating a column component, which has been moved behind of the component', function() {
            var componentsB = [
              {
                input: false,
                key: 'columns1',
            ...
            it('Rearranged Column components will appear in the same position as the local form (the most recent update)', function(done) {
              initialForm.components = componentsC;
          ...
          describe('Updating a component which has been moved from col1 to col2', function() {
            ...
            it('Modified column components will appear in the last stable place, with the newest local settings', function(done) {
              initialForm.components = componentsC;
