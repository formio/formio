...
module.exports = (router) => {
  ...
  return (req, res, next) => {
    ...
    const formId =
      params.hasOwnProperty('form') && params.form !== 'undefined' ? params.form : null;

    // Get the formId from the request url.
    let subId =
      params.hasOwnProperty('submission') && params.form !== 'undefined' ? params.submission : null;

    // Get the roleId from the request url.
    const roleId =
      params.hasOwnProperty('role') && params.role !== 'undefined' ? params.role : null;
