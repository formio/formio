    ...
    components: [
      {
        ...
        components: [
          {
            label: '<b>Create Own Submissions</b>',
          ...
          {
            label: '<b>Create All Submissions</b>',
            labelPosition: 'left-left',
            widget: 'choicesjs',
            tableView: true,
            multiple: true,
    ...
    <div className="panel access active">
      <div className="form-access-wrap">
        <div className="comp-inside-box yellow">
          <p>
            User Permissions allow you to control who can create, view, and modify form submissions.
            Here you may assign Project Roles to permissions. <span className="strong">Roles</span>{' '}
            can be created and edited in the <span className="strong">default template</span> file.
          </p>
        </div>
            ...
            <Form
              ...
              submission={{
                data: {
                  ...
                  submissionAccess: mapAccessToSubmission(submissionAccess),
                },
              }}
