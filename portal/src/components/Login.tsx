    ...
    <div className="login-wrap">
      <div className="login-inside card">
        ...
        <div className="login-help-wrap">
          <p>
            <span className="strong">Admin / First Time Login</span>: Use the account that was
            created during installation.
          </p>
          <p>
            Additional accounts are created by logging in with the admin account and adding an entry
            to the <span className="strong">Admin</span> resource.
          </p>
        </div>
        <div className="login-help-wrap">
          <a target="_blank" href="https://help.form.io/" className="link" rel="noreferrer">
