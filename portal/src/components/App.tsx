            ...
            <Route path="/resource/:id" nest>
              {(params) => (
                <div className="panels">
                  ...
                  {location === `/resource/${params.id}/access` && <AccessPanel type="resource" />}
                </div>
              )}
            </Route>
              ...
              {(params) => (
                <div className="panels">
                  ...
                  {(location === `/form/${params.id}` ||
                    location === `/form/${params.id}/edit`) && <EditPanel type="form" />}
                  {location === `/form/${params.id}/use` && <UsePanel type="form" />}
                  {location === `/form/${params.id}/view` && <ViewDataPanel />}
                  {location === `/form/${params.id}/actions` && <ActionsPanel type="form" />}
                  {location === `/form/${params.id}/access` && <AccessPanel type="form" />}
                </div>
              )}
            </Route>
            <Route path="/">
