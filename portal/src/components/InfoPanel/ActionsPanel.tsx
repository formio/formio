        ...
        <div className="context-info card">
          ...
          <div className="context-data form-actions active">
            <div className="context-header">
              <h2 className="strong">
                <span className="item-type-label">{name}</span> Actions
              </h2>
            </div>
            <div className="context-expand">
              <p>Configure actions that will execute upon submission.</p>
              <ul>
                <li className="enterprise">
                  <span className="strong">Premium Actions</span>
                  <ul>
                    ...
                    <li>SQL Connector</li>
                    <li>Pre-configured, most-used actions</li>
                  </ul>
                </li>
                <li className="enterprise">
                ...
                <li className="enterprise">
                  Built-in <span className="strong">user authentication</span>, including OAuth,
                  SAML, and more.
                </li>
              </ul>
