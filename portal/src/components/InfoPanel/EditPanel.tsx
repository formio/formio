        ...
        <div className="context-info card">
          ...
          <div className="context-data edit-form active">
            <div className="context-header">
              <h2 className="strong">Self-Hosting With Form.io Enterprise </h2>
            </div>
            <div className="context-expand">
              ...
              <p>
                Form.io’s Enterprise offering includes many different features that make it easier
                to build and manage more complex form-centric applications. Capabilities available
                within the Enterprise offering are denoted by the Form.io logo.
              </p>
              <ul>
                <li className="enterprise">
                  <span className="strong">
                    <span className="item-type-label">{name}</span> Revisions
                  </span>
                  <ul>
                    <li>
                      Automatically tracks the history of form revisions.{' '}
                      <a
                        target="_blank"
                    ...
                    <li>
                      <span className="strong">Nested Forms</span> and form revisions within the
                      nested forms.
                    </li>
                  </ul>
                </li>
                <li className="enterprise">
                  <span className="strong">Premium Components</span>
                  <ul>
                    ...
                    <li>Tagpads</li>
                    <li>Sketchpads</li>
                    <li>Review Pages (summary before submission)</li>
                    <li>Signatures</li>
                    <li>Custom JSON</li>
                    <li>Data Tables</li>
                  </ul>
                ...
                <li className="enterprise">
                  <span className="strong">Encrypted fields</span>
                </li>
                <li className="enterprise">
                  <span className="strong">Advanced conditional logic</span>
                </li>
              </ul>
