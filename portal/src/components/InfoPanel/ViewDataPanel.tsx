        ...
        <div className="context-info card">
          ...
          <div className="context-data view-data active">
            ...
            <div className="context-expand">
              <p>
                Data can be viewed, edited, and deleted from here as well as exported to JSON or
                CSV.
              </p>
              <ul>
                <li className="enterprise">
                  <span className="strong">Submission revisions</span> are shown in context of each
                  submission
                </li>
                <li className="enterprise">
                  <span className="strong">Print to PDF</span> export option
                </li>
              </ul>
